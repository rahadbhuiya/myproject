...
Route::middleware(['auth'])->prefix('admin')->group(function () {
    ...
    Route::post('/order/{orderId}/complete', [\App\Http\Controllers\Admin\AdminController::class, 'completeOrder']);
});
...
Route::prefix('admin')->name('admin.')->group(function () {
    Route::get('/dashboard', [AdminController::class, 'index'])->name('dashboard');
    Route::post('/order/{orderId}/complete', [AdminController::class, 'completeOrder'])->name('order.complete');
});
